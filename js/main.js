...
const openDivVendor = document.querySelector(".openModal-vendor");
 ...
 const openDivstock = document.querySelector(".openModal-stock");
    ...
    modalstock.addEventListener("click", (e) => {
     ...
     const openfreightcost = document.querySelector(".openModal-freight-cost");
    const modalfreightcost = document.getElementById("modalOverlay-freight-cost");
    const xBtnfreightcost = document.getElementById("x-freight-cost");

     openfreightcost.addEventListener("click", () => {
      modalfreightcost.style.display = "flex";
    });

    xBtnfreightcost.addEventListener("click", () => {
      modalfreightcost.style.display = "none";
    });

    modalfreightcost.addEventListener("click", (e) => {
      if (e.target === modalfreightcost) {
        modalfreightcost.style.display = "none";
      }
    });
